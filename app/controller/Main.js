Ext.define('Touch2Demo.controller.Main', {
	...
	control: {
	    ...
	    'selectfield[name=filter]': {
		change: 'onFilterChange'
	    },
	    'button[action=testehaha]': {
		tap: 'onFilterChange'
	    }
	}
    },
...
//	salvarColeta.sync();
	...
	var form = field.up('coletasform'),
		fooField = form.child('selectfield[name=foo]'),
		newValue2 = newValue.data.value,
		options = {
		    '': [
			{text: '', value: ''},
			{text: 'Cash', value: 'cash'},
			{text: 'Cheque', value: 'cheque'},
			{text: 'Bank Draft', value: 'draft'}
		    ],
		    'cor': [
			{text: 'Branco', value: ''},
			{text: 'Vermelho', value: 'cheque'},
			{text: 'Preto', value: 'draft'}
		    ],
		    'letra': [
			{text: 'A', value: ''},
			{text: 'B', value: 'cash'},
	...
	fooField.setOptions(options[newValue2]);
	fooField.enable();
    }
});
